...
| `type`                | yes     | `string`  | It has to be `rich_message`.                                         | 
| `recipients`          |   yes   | `string`  | Those who can display a rich message: `all` (default) or `agents`                         |
| ``                    |         | ``        |                                                                     |
| ``                    |         | ``        |                                                                     |
| ``                    |         | ``        |                                                                     |
| ``                    |         | ``        |                                                                     |
...
| `recipients`                     | always    | Values: `all` or `agents` |
| `template_id`                    | required  | Defines how every Rich Message will be presented. Values: `card` or `quick_replies`.              |
