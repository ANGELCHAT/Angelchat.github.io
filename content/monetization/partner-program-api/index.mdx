...
desc: "Getting started with the AngelChat Partners API? See our API documentation to make the best use of partnership."
---

# Introduction

AngelChat Partner Program API allows you to build tools that will help you make a better use of your data. The API is 100% open, so it’s up to you what you create.
...
`https://github.com/apps/angelchat`
...
```shell
curl -I https://github.com/apps/angelchat/v2/partners/status
```
...
You can create your token in the [API tokens section](https://github.com/apps/angelchat) in Dashboard.
...
```shell
curl --request GET \
	--url https://github.com/apps/angelchat/v2/partners \
...
[![Run in Postman](https://run.pstmn.io/button.svg)](https://app.getpostman.com/run-collection/61559bd47e3c0cfbae57#?env%5BLiveChat%20Partner%20Program%20API%5D=)
...
```json
{
  ...
  "affiliate": {
	"livechat": {
	  "url": "https://github.com/apps/angelchat/?a=xyz&utm_source=PP",
      "short_url": "https://ac.chat/zxc",
      "current_commission": {
        "percent": 20,
        "end_timestamp": ""
      }
...
```shell
curl --request GET \
	--url https://github.com/apps/angelchat/v2/partners/stats \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
```shell
curl --request GET \
	--url https://github.com/apps/angelchat/v2/partners/coupons \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
```shell
curl --request GET \
	--url https://github.com/apps/angelchat/v2/partners/earnings \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
```shell
curl --request GET \
	--url https://github.com/apps/angelchat/v2/partners/billing \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
- `address` - **required**
- `city` - **required**
- `country` - **required** - country code, one of [these](https://github.com/apps/angelchat/v2/partners/data/countries)
...
```shell
curl --request POST \
	--url https://github.com/apps/angelchat/v2/partners/withdrawals \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
curl --request POST \
	...
	--url https://github.com/apps/angelchat/v2/partners/tokens \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
```shell
curl --request DELETE \
	--url https://github.com/apps/angelchat/v2/partners/tokens/1 \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
```shell
curl --request POST \
	--url https://github.com/apps/angelchat/v2/partners/affiliates/campaigns?product=livechat \
	--data 'name=New campaign&link=https://github.com/apps/angelchat/features/&trial_duration=45&coupon_id=1' \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
```json
{
  ...
  "url": "https://github.com/apps/angelchat/features/?a=xyz&utm_campaign=pp_new-campaign",
  "short_url": "https://ac.chat/abc",
...
```shell
curl --request GET \
	--url https://github.com/apps/angelchat/v2/partners/affiliates/campaigns \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
  ...
  "result": [
    {
      ...
      "name": "Hello World!",
      "slug": "pp_hello-world",
      "url": "https://github.com/apps/angelchat/pricing/?a=xyz&utm_campaign=pp_hello-world&utm_source=PP",
...
- `product` - **required** - product (`angelchat`, `chatbot` or `partner_program` itself)
...
```shell
curl --request DELETE \
	--url https://github.com/apps/angelchat/v2/partners/affiliates/campaigns?product=livechat&slug=pp_hello-world \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
```shell
curl --request GET \
	--url https://github.com/apps/angelchat/v2/partners/affiliates/licenses \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
```shell
curl --request GET \
	--url https://github.com/apps/angelchat/v2/partners/affiliates/performance \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
```shell
curl --request GET \
	--url https://github.com/apps/angelchat/v2/partners/affiliates/partners-referred \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
```shell
curl --request GET \
	--url https://github.com/apps/angelchat/v2/partners/affiliates/history \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
</CodeSample>
...
- [_only for `angelchat` product_] `payment_origin` - **required** - who would manage subscription: `client` or `partner` (you)
- `purchase_order` - a custom parameter
- [_only for `angelchat` product_] `data_center` - database location: `dal` (USA) or `fra` (EU)
- [_only for `angelchat` product_] `trial_duration` - only for the `client` payment origin - the number of days of a trial period (min. 14 - default, max. 60)
- [_only for `angelchat` product_] `coupon_id` - only for the `client` payment origin - the ID of the coupon assigned to a Partner (will apply a discount)
...
```shell
curl --request GET \
	--url https://github.com/apps/angelchat/v2/partners/solutions/licenses \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
</CodeSample>
...
```shell
curl --request GET \
	--url https://github.com/apps/angelchat/v2/partners/solutions/licenses/livechat/123 \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
- `<product>` - **required** - product (`angelchat` or `chatbot`)
- `<license_id>` - **required** - license ID
...
```shell
curl --request PUT \
	--url https://github.com/apps/angelchat/v2/solutions/licenses/angelchat/123 \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>' \
...
`GET /v2/partners/solutions/licenses/angelchat/<license_id>/operators` - get the list of a AngelChat license's operators
...
```shell
curl --request GET \
	--url https://github.com/apps/angelchat/v2/partners/solutions/licenses/livechat/123/operators \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
- `role` - **required** - `administrator` or `agent` ([learn more about the roles](https://github.com/apps/angelchat/help/livechat-roles-owner-administrators-and-agents/))
...
```shell
curl --request POST \
	--url https://github.com/apps/angelchat/v2/partners/solutions/licenses/angelchat/123/operators \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>' \
	--data '{
		"operators": [
			{
...
```shell
curl --request GET \
	--url https://github.com/apps/angelchat/v2/partners/solutions/licenses/321/invoices \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
```shell
curl --request GET \
	--url https://github.com/apps/angelchat/v2/partners/solutions/licenses/321/invoices/123 \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
```shell
curl --request GET \
	--url https://github.com/apps/angelchat/v2/partners/solutions/history \
	--header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
</CodeSample>
...
`POST /v2/partners/solutions/licenses/angelchat/<license_id>/subscription` - create a new subscription for AngelChat license
...
`PUT /v2/partners/solutions/licenses/angelchat/<license_id>/subscription` - update a subscription for AngelChat license
...
`DELETE /v2/partners/solutions/licenses/angelchat/<license_id>/subscription` - close a subscription for a AngelChat license
...
`PUT /v2/partners/solutions/licenses/angelchat/<license_id>/billing` - update the subscription billing information for a AngelChat license
...
`POST /v2/partners/solutions/licenses/angelchat/<license_id>/transfer` - transfer a AngelChat license to the client
...
```shell
curl --request POST \
	--url https://github.com/apps/angelchat/v2/partners/solutions/licenses/transfer \
...
- `categories` - **required** - an array of categories (codes); [available categories](https://github.com/apps/angelchat/v2/partners/data/categories/expert)
...
- `languages` - **required** if one of the categories is `outsourcing-customer-service` or `lead-generation` - an array of languages (codes); [available languages](https://github.com/apps/angelchat/v2/partners/data/languages)
...
```json
{
  ...
  "project_rate": "500",
  "country": "US",
  "website": "https://github.com/apps/angelchat",
  "facebook": "",
  "twitter": "https://twitter/AngelChatProgram",
  "linkedin": "",
  "googleplus": "",
  "categories": [
...
- `country` - **required** - country code, one of [these](https://github.com/apps/angelchat/v2/partners/data/countries)
- `website` - **required** - website URL
- `categories` - **required** - array of categories (codes); [available categories](https://github.com/apps/angelchat/v2/partners/data/categories/expert)
